...
@$pb.GrpcServiceName('login.LoginService')
class LoginServiceClient extends $grpc.Client {
  static final _$login = $grpc.ClientMethod<$0.LoginRequest, $0.LoginResponse>(
      '/login.LoginService/Login',
      ($0.LoginRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.LoginResponse.fromBuffer(value));
  static final _$signup = $grpc.ClientMethod<$0.LoginRequest, $0.LoginResponse>(
...
abstract class LoginServiceBase extends $grpc.Service {
  $core.String get $name => 'login.LoginService';
  ...
  $async.Future<$0.LoginResponse> signup_Pre($grpc.ServiceCall call, $async.Future<$0.LoginRequest> request) async {
